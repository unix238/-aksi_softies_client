      ...
      <div className='wrapper'>
        <div className={cl.blocks__contaier}>
            ...
            <div className={cl.blockItems}>
              <div className={cl.item}>
                ...
                <div className={cl.texts}>
                  {FooterTexts[currentLanguage].address.map((option) => {
                    return (
                      <div
                        key={`${option}key for footer`}
                        className={[cl.text, cl.links].join(' ')}
                      >
                        {option}
                      </div>
                    );
              ...
              <div className={cl.item}>
                ...
                <div className={cl.texts}>
                  <div className={cl.text}>
                    <img src={callIcon} />
                    {FooterTexts[currentLanguage].contact[0]}
                  </div>
                  <div className={cl.text}>
                    <img src={whatsAppIcon} />
                    {FooterTexts[currentLanguage].contact[1]}
                  </div>
                  <div className={cl.text}>
                    <img src={telegramIcon} />
                    {FooterTexts[currentLanguage].contact[2]}
                  </div>
                </div>
              </div>
              <div className={cl.item}>
                ...
                <div className={cl.texts}>
                  <div className={cl.text}>
                    <img src={instIcon} />
                    <a
                      href='https://instagram.com/aksi_softies'
                      target='_blank'
                      className='instLink'
                    >
                  ...
                  <div className={cl.text}>
                    <img src={instIcon} />
                    <a
                      href='https://instagram.com/aksi_kus'
                      target='_blank'
                      className='instLink'
                    >
              ...
              <div className={cl.item}>
                ...
                <div className={cl.texts}>
                  {FooterTexts[currentLanguage].support.map((option) => {
                    return (
                      <div
                        key={`${option}key for footer`}
                        className={[cl.text, cl.links].join(' ')}
          ...
          <div className={cl.button__container}>
            ...
            <div className={cl.btn}>{FooterTexts[currentLanguage].button}</div>
