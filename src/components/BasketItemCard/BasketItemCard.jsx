      ...
      <div className={cl.item}>
        <div className={cl.left}>
          <Link to={`/detail/${currentItem._id}`}>
            <div className={cl.image}>
              <img src={config.url + currentItem.images[0]} />
            </div>
          </Link>
          <div className={cl.texts}>
            ...
            <div className={cl.size}>Размер: {currentItem.sizes[id.size]}</div>
          </div>
        </div>
        ...
        <div className={cl.price}>
          <div className={cl.price__text}>
            <span className={cl.bold}>
              {currentItem.price[id.size].toLocaleString(undefined, {
                maximumFractionDigits: 2,
              })}{' '}
              ₸
            </span>
          </div>
          <div className={cl.button} onClick={removeItemFromBasketHandler}>
            Удалить
          </div>
        </div>
      </div>
